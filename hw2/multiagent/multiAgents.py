...
def betterEvaluationFunction(currentGameState):
    ...
    def place(currentPos, currentGhostPoses) :
        return (currentPos[0]-currentGhostPoses[0][0]) * (currentPos[0]-currentGhostPoses[1][0]) > 0 and (currentPos[1]-currentGhostPoses[0][1]) * (currentPos[1]-currentGhostPoses[1][1]) > 0
    ### use ghost to evaluate score
